...
public class HistoryBook {
    public String book_id, bookname, publisher;
    public String writer1,writer2,writer3,shelf,room;
    ...
    public HistoryBook(String bookid,String bookname,String writer1,String writer2,String writer3,String shelf,String room) {
        this.book_id=bookid;
